...
fun WebPromptDialog(
    ...
    when (promptRequest) {
        ...
        is WebPromptRequest.Permission -> {
            var rememberChoice by remember { mutableStateOf(true) }
            val permIcon = when (promptRequest.permissionType) {
                SitePermissionEntity.PERMISSION_MICROPHONE -> Icons.Default.Mic
                SitePermissionEntity.PERMISSION_CAMERA -> Icons.Default.Videocam
                SitePermissionEntity.PERMISSION_GEOLOCATION -> Icons.Default.LocationOn
                SitePermissionEntity.PERMISSION_NOTIFICATION -> Icons.Default.Notifications
                else -> Icons.Default.Security
            }

            AlertDialog(
                onDismissRequest = {
                    promptRequest.onDeny(false)
                },
                icon = {
                    Icon(
                        imageVector = permIcon,
                        contentDescription = "Permiso web",
                    ...
                    androidx.compose.foundation.layout.Column {
                        ...
                        Row(
                            ...
                            Checkbox(
                                ...
                                modifier = Modifier.testTag("dialog_perm_remember_checkbox")
                            )
                            Spacer(modifier = Modifier.width(6.dp))
                            Text(
                                text = "Recordar mi elección para este sitio",
                                style = MaterialTheme.typography.bodySmall
                            )
                        }
                    }
                ...
                confirmButton = {
                    Button(
                        onClick = {
                            promptRequest.onGrant(rememberChoice)
                        },
                        modifier = Modifier.testTag("dialog_perm_allow_button")
                    ) {
                        Text("Permitir")
                    }
                },
                dismissButton = {
                    OutlinedButton(
                        onClick = {
                            promptRequest.onDeny(rememberChoice)
                        },
                        modifier = Modifier.testTag("dialog_perm_deny_button")
                    ) {
                        Text("Bloquear")
                    }
                }
